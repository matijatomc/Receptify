...
@aot_dso_cache = dso_local local_unnamed_addr global [819 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x02418491c82cce7d, ; from name: aot-Receptify
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x05eed9b339eaba90, ; from name: libaot-Receptify
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x1ec2f32019c35d82, ; from name: aot-Receptify.dll.so
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5514d92e91b63693, ; from name: libaot-Receptify.dll.so
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb4512384db3f7e6b, ; from name: libaot-Receptify.so
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc8eb55570f005eb9, ; from name: Receptify.dll.so
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc8f2c0adaa4a5459, ; from name: aot-Receptify.so
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd34f605b84cc897c, ; from name: Receptify
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf9e8657237e39b3c, ; from name: Receptify.so
		i64 u0x5514d92e91b63693, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Receptify.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.receptify\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [24 x i8] c"libaot-Receptify.dll.so\00", align 16
